...
<%
	// 이 영역은 JSP문서에서 Java코드를 사용할 수 있는 영역으로 '스크립트릿'이라고 한다.
	/*  */
	String name = "홍길동";
%>

<%-- 
<%= 변수명 또는 수식 %> → JSP문서에서 변수나 수식의 결과를 출력할때 사용한다. 
--%>
<!-- 
	<form>태그의 속성
	1) action → <form>태그에서 전송한 데이터를 받아서 처리할 문서명 서블릿URL(생량하면 현재 문서명으로 설정된다.)
