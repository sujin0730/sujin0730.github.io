...
/*
	...
	- /servletTest01 → 서블릿 요청 URL 패턴
 */

// 서블릿 클래스는 HttpServlet을 상속해서 작성한다.
public class ServletTest01 extends HttpServlet {
	// 이서블릿 클래스는 service()메서드 또는 doGet()메서드나 doPost()메서드를 재정의해서 작성한다.
	
	// doGet()메서드나 doPost()메서드는 service()메서드를 통해서 호출된다.
	// HttpServletRequest객체 → 서비스 요청에 관련된 정보 및 메서드를 관리하는 객체
	// HttpServletResponset객체 → 서비스응답에 관련된 정보 및 메서드를 관리하는 객체
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        .append("<body>")
        .append("<h2 style='text-align:center;'>안녕하세요. 첫번째 Servlet프로그램입니다.</h2>")
        .append("</body></html>");
